							...
							<tbody>
								...
								if (mysqli_num_rows($result6) > 0) {
									while ($row = mysqli_fetch_assoc($result6)) {
										...
										echo '<td><a href="./../products/viewone.php?id=' . $row['id'] . '"><span class="btn" style="background-color: #8de02c; text-decoration: none; padding: 5px; border-radius: 5px;">View</span></a></td>';
